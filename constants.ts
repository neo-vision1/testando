...
export const SUPABASE_URL: string = 'https://xrezuunshjzefdncsvgv.supabase.co';
export const SUPABASE_ANON_KEY: string = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhyZXp1dW5zaGp6ZWZkbmNzdmd2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU0Nzk5NDEsImV4cCI6MjA4MTA1NTk0MX0.grxtcbI_39x_RARgxrJxNlx972M_q5mTQ77rCC3_hyI';
